...
class SecurityFilters {
  /**
    ...
    static nonAuthenticatedActions = [
			...
			//[controller: 'signup', action: 'registration']
    ]
    ...
    static authenticatedActions = [
            [controller: 'landingPage', action: 'index', roles: ['ROLE_ADMIN', 'ROLE_USER']]
			//[controller: 'signup', action: 'registration', roles:['ROLE_ADMIN']]
    ]
